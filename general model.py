...
class General:
    ...
    def performance_summary(self, testing_and_training_path, class_boundary = None):
...
#test1 = General(r'C:\Users\Jack\Documents\Uni\Year_4\Project\CNNs\scaled class boundary tests2\best network test 0.1.ckpt',r'C:\Users\Jack\Documents\Uni\Year_4\Project\CNNs\scaled class boundary tests 2\best network info3 0.1.npy')
#test1.performance_summary(r'C:\Users\Jack\Documents\Uni\Year_4\Project\data\testing and training data\0.1.npy', class_boundary=0.095)
#test2 = General(r'C:\Users\Jack\Documents\Uni\Year_4\Project\CNNs\scaled class boundary tests2\best network test 0.02.ckpt',r'C:\Users\Jack\Documents\Uni\Year_4\Project\CNNs\scaled class boundary tests 2\best network info3 0.02.npy')
#test2.performance_summary(r'C:\Users\Jack\Documents\Uni\Year_4\Project\data\testing and training data\0.02.npy', class_boundary=0.02)
#test3 = General(r'C:\Users\Jack\Documents\Uni\Year_4\Project\CNNs\scaled class boundary tests2\best network test 0.03.ckpt',r'C:\Users\Jack\Documents\Uni\Year_4\Project\CNNs\scaled class boundary tests 2\best network info3 0.03.npy')
#test3.performance_summary(r'C:\Users\Jack\Documents\Uni\Year_4\Project\data\testing and training data\0.03.npy', class_boundary=0.0336)
#test4 = General(r'C:\Users\Jack\Documents\Uni\Year_4\Project\CNNs\scaled class boundary tests2\best network test 0.06.ckpt',r'C:\Users\Jack\Documents\Uni\Year_4\Project\CNNs\scaled class boundary tests 2\best network info3 0.06.npy')
#test4.performance_summary(r'C:\Users\Jack\Documents\Uni\Year_4\Project\data\testing and training data\0.06.npy', class_boundary=0.0566)
#test5 = General(r'C:\Users\Jack\Documents\Uni\Year_4\Project\CNNs\scaled class boundary tests2\best network test 0.16.ckpt',r'C:\Users\Jack\Documents\Uni\Year_4\Project\CNNs\scaled class boundary tests 2\best network info3 0.16.npy')
#test5.performance_summary(r'C:\Users\Jack\Documents\Uni\Year_4\Project\data\testing and training data\0.16.npy', class_boundary=0.16)
